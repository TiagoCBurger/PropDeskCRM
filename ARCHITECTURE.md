...
- **Storage (Supabase Storage, R2 opcional)**: buckets lógicos `whatsapp-media`, `ai-policy`, `lgpd-exports`, `skill-assets` (privados) e `brand-logos` (público). URLs assinadas. Porta `lib/storage/` (`STORAGE_BACKEND=supabase|r2`, default supabase). Dual-write/backfill ainda são roadmap — [`docs/roadmap/migracao-storage-r2.md`](docs/roadmap/migracao-storage-r2.md). Operador: [`docs/runbooks/topologia-vps-supabase-cloud-r2.md`](docs/runbooks/topologia-vps-supabase-cloud-r2.md).

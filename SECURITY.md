...
Use o [relato privado de vulnerabilidades do GitHub](https://github.com/TiagoCBurger/PropDeskCRM/security/advisories/new) — o relato chega só aos mantenedores, e o histórico fica auditável.

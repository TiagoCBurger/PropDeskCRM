...
O app roda dentro de um container (`ghcr.io/tiagocburger/deskcommcrm`) sem nenhum volume do host.
...
- Sobe `APP_IMAGE=ghcr.io/tiagocburger/deskcommcrm:<versão>` em vez de `latest`.
